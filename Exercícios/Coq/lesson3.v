...
Proof.
  intros.
  rewrite (elem_corr a l1 (a::l2)). (* usar a proposiçao anterior - reescrever com novos valores *)
  simpl. elim (Z.eq_dec a a).
  (*Search orb. ou Search "||". --> para ver todas as proposições relacionadas com o orb*)
  - intros.
...
Proof.
  ...
  - intros. destruct l.
    ...
    + elim IHl.
      ...
      * discriminate. (* termos construidos com construtores diferentes são de certeza diferentes *)
Qed.
